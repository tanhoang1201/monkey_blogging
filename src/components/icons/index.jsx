export const EyeIcon = () => {
	return (
		<svg className="w-6 h-6" viewBox="0 0 22 14" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
...
export const EyeClosedIcon = () => {
	return (
		<svg className="w-6 h-6" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
...
export const SearchIcon = () => {
	return (
		<svg className="w-6 h-6" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
			<ellipse
				cx="7.66669"
				cy="7.05161"
				rx="6.66669"
